...
public class ImageSelectorActivty extends BaseImageSelectorActivity implements
	 ...
	 * 照相机照片
	 */
	protected ImageButton shouCamera;
	...
	private void initViews() {
		...
		shouCamera = (ImageButton) findViewById(R.id.shouCamera);
	...
	private void initListeners() {
		...
		browserView.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(ImageSelectorActivty.this,
		...
		shouCamera.setOnClickListener(new OnClickListener() {
	...
	private void loadImages() {
		new Thread() {
			...
			public void run() {
				mCursor = MediaHelper
						.getImagesCursor(ImageSelectorActivty.this);
				final ArrayList<Bucket> bucketList = MediaHelper
						.getBucketList(ImageSelectorActivty.this);
	...
	private void bindImageGridView(Cursor cursor) {
		if (imageAdapter != null) {
			...
			imageAdapter = new ImageCursorAdapter(ImageSelectorActivty.this,
					cursor, paramContext.getSelectedFile()) {
				@Override
	...
	private void bindBucketListView(ArrayList<Bucket> bucketList) {
		if (bucketList == null)
			return;
		albumListView.setAdapter(new BaseAdapter<Bucket>(
				ImageSelectorActivty.this, bucketList) {
			@Override
	...
	private void choosePicQuality() {
		final ActionSheet actionSheet = new ActionSheet(
				ImageSelectorActivty.this);
	...
	private void refreshUi() {
		...
		picQuality.setVisibility(paramContext.hasQulityMenu() ? View.INVISIBLE
				: View.INVISIBLE);
	}
	...
	private void popAlbum() {
		...
		new AnimUtil(ImageSelectorActivty.this, R.anim.translate_up_current)
	...
	private void hideAlbum() {
		new AnimUtil(ImageSelectorActivty.this, R.anim.translate_down)
				.setLinearInterpolator().startAnimation(albumRLayout);
