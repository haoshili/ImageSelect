 ...
 * 2015-3-19
 */
public class ImageBrowserActivity extends BaseImageSelectorActivity{
	...
	class ImagePagerAdapter extends PagerAdapter{
	    ...
	    public Object instantiateItem(ViewGroup collection, int position){
	        ...
	        ImageLoadUtil
	        .getInstance(3,ImageLoadUtil.Type.LIFO)
	        .loadImage(path,convertView.getImageView(),bindListener(convertView));
			return convertView;
		}
